...
namespace WindowsNotification
{
    ...
    class WindowsNotificationClass
    {
         ...
         * @var string
         */
        private static $ClientSecret = "xlientSecret";
    ...
    final class TemplateToast
    {
         ...
         * @return string
         */
        public static function ToastText02($headLineText,$bodyText, $section, $sound = TemplateToast::NotificationDefault)
        {
            return '<?xml version="1.0" encoding="utf-8"?><toast '.TemplateToast::SoundDuration($sound).' launch="'.$section.'"><visual><binding template="ToastText02"><text id="1">'.$headLineText.'</text><text id="2">'.$bodyText.'</text></binding></visual>'.$sound.'</toast>';
        }
        /**
